package com.example.user.afinal.fcm;
...
import com.example.user.afinal.Views.NotificationActivity;
...
public class FCMService extends FirebaseMessagingService {
    ...
    private void sendNewPromoBroadcast(RemoteMessage remoteMessage) {
        Intent intent = new Intent(NotificationActivity.ACTION_NOTIFY_NEW_PROMO);
